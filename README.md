...
Once you have all the necessary dependencies you can use `pnpm build` to build the extension.
...
Check [package.json](package.json) for other scripts you can run to assist with development.
